...
def project():
    ...
    if request.method == 'POST':
        ...
        if selectedProject == 'collatz':
            ...
            return render_template("index.html", project = selectedProject, steps = steps)
            ...
            if encodedString:
                return render_template("index.html", project = selectedProject, encodedString = encodedString)
            ...
            if type(results) is 'list':
                ...
                return render_template("index.html", project = selectedProject, results = results, time = (endTime-startTime))
    ...
    return render_template("index.html", project = selectedProject)
